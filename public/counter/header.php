...
"https://media.geeksforgeeks.org/wp-content/uploads/20221210183322/8.png"
        class="icn"
        alt="">
    <a href="/counter/profile" class="dp">
    <img src=
...
<div class="navcontainer">
    <nav class="nav">
        <div class="nav-upper-options">
                ...
                <a href="/counter/home" class="nav-option option2">
                ...
                <a href="/counter/new_order" class="nav-option option2">
                    <img src="../images/icons/dashboard.svg"
                        class="nav-img"
                        alt="dashboard">
                    <h3> New Order</h3>
                ...
                <a href="/counter/pending_payments" class="nav-option option2">
                    <img src="../images/icons/dashboard.svg"
                        class="nav-img"
                        alt="dashboard">
                    <h3> Pending</h3>
                ...
                <a href="/counter/all_orders" class="option2 nav-option">
